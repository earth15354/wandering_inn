...
MY_CONDA_ENV_NAME="wandering_env_conda"                 # name of the conda environment
MY_CONDA_ENV_CFG_FILE="env_setup/wi-m1.yml" # name/path of the conda environment config file
